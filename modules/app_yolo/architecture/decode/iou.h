...
#ifndef APP_YOLO_IOU_H__
#define APP_YOLO_IOU_H__
 ...
 * @brief Nms function.
 */
class IouPlugin : public PluginNodeBase {
 public:
  IouPlugin();
  ~IouPlugin();
  ...
  /**
   * @brief     Iou.
   * @param[in] Box& box_a, Box& box_b.
   * @return    float.
   */
  float Iou(Box& box_a, Box& box_b);
