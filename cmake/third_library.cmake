...
set(GLOG_DIR "/home/IM/${COMPLIER_FLAG}/glog0.6.0")
set(EIGIN_DIR "/home/IM/${COMPLIER_FLAG}/eigen3.4")
set(GFLAGS_DIR "/home/IM/${COMPLIER_FLAG}/gflags_2.2.2")
set(OPENCV_DIR "/home/IM/${COMPLIER_FLAG}/opencv3.4.5")
set(YAMLCPP_DIR "/home/IM/${COMPLIER_FLAG}/yaml_cpp")
set(TENSORRT_DIR "/home/IM/${COMPLIER_FLAG}/tensorrt")
